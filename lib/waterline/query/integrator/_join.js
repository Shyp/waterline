...
module.exports = function _join(options) {
  ...
  // Usage
  var invalid = false;
  invalid = invalid || lusitania(options).to({
    type: 'object'
  });
  ...
  invalid = invalid || lusitania(options.parent).to({
    type: 'array'
  });
  invalid = invalid || lusitania(options.child).to({
    type: 'array'
  });
  invalid = invalid || lusitania(options.parentKey).to({
    type: 'string'
  });
  invalid = invalid || lusitania(options.childKey).to({
    type: 'string'
  });
